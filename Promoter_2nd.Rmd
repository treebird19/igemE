...
knitr::kable(
  igem_part <- data.frame(id = 1:3,
             ...
             backbone = rep("-", 3),
             device_id = paste0("D", sprintf("%04d", rep(1, 3))),
             team_name = rep("Nottingham", 3),
             user = rep("sb.h", 3))
  )
...
knitr::kable(
  igem_obs <- data.frame(id = 1,
             ...
             link = c("http://2018.igem.org/Team:Nottingham/Achievements#improved-parts"))
  )
